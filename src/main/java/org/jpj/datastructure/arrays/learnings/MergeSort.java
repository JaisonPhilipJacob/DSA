package org.jpj.datastructure.arrays.learnings;
...
public class MergeSort {
    ...
    public static void merge(int[] input, int start, int mid, int end) {
        ...
        //If sorting needs to be in descending order this check will change to input[mid - 1] >= input[mid]
        ...
        while (i < mid && j < end) {
            //if sorting needs to be in descending order this check changes to input[i] >= input[j]
